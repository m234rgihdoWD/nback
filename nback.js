...
function trialRoutineEnd(snapshot) {
    return async function () {
      ...
      // set feedback BEFORE saving (so feedbackText can read it)
      if (correctness_code === 3) {
        window.feedbackMsg = "Правильно!";
      } else if (correctness_code === 1) {
        window.feedbackMsg = "Пропустили таргет";
      } else if (correctness_code === 0) {
        window.feedbackMsg = "Неправильно!";
      } else {
        window.feedbackMsg = "";
      }
